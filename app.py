...
class HttpWSSProtocol(websockets.WebSocketServerProtocol):
    ...
    async def http_handler(self, method, path, version):
        ...
        try:
            ...
            googleRequestJson = json.loads(alexagoogleRequest)
            ESPparameters = {}
            ...
            ESPparameters['action'] = command['action']['value']
            
            ESPparameters['device'] = command['device']['value']

            ESPparameters['location'] = command['location']['value']
